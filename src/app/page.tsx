...
export default function Home() {
  return (
    <>
      ...
      {/* Services Section */}
      <section className="relative py-20 lg:py-28 bg-[#1a1714]">
        {/* Background Pattern */}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#1a1714] via-[#1a1714]/95 to-[#1a1714]/80" />

                {/* Content */}
                <div className="relative p-6 lg:p-8">
                  <div className="w-14 h-14 flex items-center justify-center border border-amber-500/30 text-amber-400 mb-5 group-hover:bg-amber-500 group-hover:text-white group-hover:border-amber-500 transition-all duration-300">
                    {service.icon}
                  </div>
                  <h3 className="font-[family-name:var(--font-poppins)] text-lg font-semibold text-white mb-3 group-hover:text-amber-400 transition-colors">
                    {service.title}
                  </h3>
      ...
      <section className="relative py-20 lg:py-28 bg-[#141210]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-12 lg:mb-16">
            ...
            <Link
              href="/projects"
              className="inline-flex items-center gap-2 px-6 py-3 border-2 border-amber-600/40 text-white font-medium hover:border-amber-500 hover:text-amber-400 hover:bg-amber-500/10 transition-all duration-300 self-start lg:self-auto"
            >
              View All Projects
              <svg
                className="w-4 h-4"
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {projects.map((project, index) => (
              ...
              >
                ...
                />
                {/* Overlay */}
                <div className="absolute inset-0 bg-gradient-to-t from-[#1a1714] via-[#1a1714]/40 to-transparent opacity-80 group-hover:opacity-90 transition-opacity" />

                {/* Content */}
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <span className="inline-block px-3 py-1 text-xs font-semibold text-amber-400 border border-amber-500/40 bg-amber-500/10 mb-3">
                    {project.category}
                  </span>
                  <h3 className="font-[family-name:var(--font-poppins)] text-lg font-semibold text-white group-hover:text-amber-400 transition-colors">
                    {project.title}
                  </h3>
                </div>

                {/* Hover Border */}
                <div className="absolute inset-0 border-2 border-transparent group-hover:border-amber-500/50 transition-colors duration-300" />
              </Link>
            ))}
          </div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-4 mb-8">
                {[
                  ...
                  <div key={index} className="flex items-center gap-3">
                    <div className="w-5 h-5 flex items-center justify-center bg-amber-500/20 text-amber-400">
                      <svg
                        className="w-3 h-3"
                        fill="currentColor"
                        viewBox="0 0 20 20"
              ...
              <Link
                href="/about"
                className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-amber-600 to-amber-500 text-white font-semibold hover:from-amber-500 hover:to-amber-400 transition-all shadow-lg shadow-amber-600/20"
              >
                Learn More About Us
                <svg
                  className="w-4 h-4"
      ...
      {/* CTA Section */}
      <section className="relative py-20 lg:py-28 bg-gradient-to-br from-amber-600 to-amber-700 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-amber-700 font-bold hover:bg-amber-50 transition-colors shadow-xl"
            >
              Get a Free Quote
              <svg
                className="w-5 h-5"
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-8 py-4 border-2 border-white text-white font-semibold hover:bg-white hover:text-amber-700 transition-colors"
            >
              <svg
                className="w-5 h-5"
                fill="none"
