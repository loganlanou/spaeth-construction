...
const PageHeader = ({ badge, title, highlight, description, backgroundImage = '/images/construction-1.jpg' }: PageHeaderProps) => {
  return (
    <section className="relative pt-32 pb-16 lg:pt-40 lg:pb-24 bg-black overflow-hidden">
      ...
      <div className="absolute top-20 right-10 w-40 h-40 border border-green-600/15 hidden lg:block" />
      <div className="absolute top-32 right-22 w-40 h-40 border border-green-600/10 hidden lg:block" />
      <div className="absolute bottom-10 left-10 w-24 h-24 border border-white/5 hidden lg:block" />

      {/* Accent Lines */}
      <div className="absolute left-0 top-1/3 w-1 h-24 bg-gradient-to-b from-green-600 to-transparent hidden lg:block" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Bottom Line */}
        <div className="mt-12 h-[3px] bg-gradient-to-r from-green-600 via-green-500/50 to-transparent max-w-xl" />
      </div>
    </section>
  );
};
